...
/********************************************************************
//    Created:     2021/10/26  09:40:11
//    File Name:   D:\XEngine_Storage\XEngine_Source\XEngine_StorageComponents\XStorage_P2XPPeer\P2XPPeer_Manage\P2XPPeer_Manage.cpp
...
//    History:
*********************************************************************/
CP2XPPeer_Manage::CP2XPPeer_Manage()
{
}
CP2XPPeer_Manage::~CP2XPPeer_Manage()
{
...
备注：
*********************************************************************/
BOOL CP2XPPeer_Manage::P2XPPeer_Manage_Add(XENGINE_P2XP_PEERINFO st_PeerInfo)
{
...
备注：
*********************************************************************/
BOOL CP2XPPeer_Manage::P2XPPeer_Manage_Get(LPCTSTR lpszAddr,XENGINE_P2XP_PEERINFO *pSt_PeerInfo /* = NULL */)
{
    PeerManage_IsErrorOccur = FALSE;
...
备注：
*********************************************************************/
BOOL CP2XPPeer_Manage::P2XPPeer_Manage_GetUser(LPCTSTR lpszUser, XENGINE_P2XP_PEERINFO *pSt_PeerInfo /* = NULL */)
{
    PeerManage_IsErrorOccur = FALSE;
...
*********************************************************************/
BOOL CP2XPPeer_Manage::P2XPPeer_Manage_GetLan(LPCTSTR lpszPubAddr, LPCTSTR lpszPriAddr, XENGINE_P2XPPEER_PROTOCOL*** pppSt_P2XPClient, int* pInt_ListCount)
{
    PeerManage_IsErrorOccur = FALSE;
...
*********************************************************************/
BOOL CP2XPPeer_Manage::P2XPPeer_Manage_GetLList(LPCTSTR lpszPubAddr, TCHAR*** pppszP2XPClient, int* pInt_ListCount)
{
    PeerManage_IsErrorOccur = FALSE;
...
备注：
*********************************************************************/
BOOL CP2XPPeer_Manage::P2XPPeer_Manage_GetWList(TCHAR*** pppszP2XPClient, int* pInt_ListCount)
{
	PeerManage_IsErrorOccur = FALSE;
...
备注：
*********************************************************************/
BOOL CP2XPPeer_Manage::P2XPPeer_Manage_Set(LPCTSTR lpszAddr,XENGINE_P2XP_PEERINFO st_PeerInfo)
{
    PeerManage_IsErrorOccur = FALSE;
...
备注：
*********************************************************************/
BOOL CP2XPPeer_Manage::P2XPPeer_Manage_Delete(LPCTSTR lpszClientAddr)
{
    PeerManage_IsErrorOccur = FALSE;
...
备注：
*********************************************************************/
BOOL CP2XPPeer_Manage::P2XPPeer_Manage_DelAll()
{
    PeerManage_IsErrorOccur = FALSE;
...
备注：
*********************************************************************/
BOOL CP2XPPeer_Manage::P2XPPeer_Manage_GetCount(int *pInt_PeerCount)
{
    PeerManage_IsErrorOccur = FALSE;
...
备注：
*********************************************************************/
BOOL CP2XPPeer_Manage::P2XPPeer_Manage_AddLan(XENGINE_P2XPPEER_PROTOCOL st_ClientAddr)
{
    PeerManage_IsErrorOccur = FALSE;
...
备注：
*********************************************************************/
BOOL CP2XPPeer_Manage::P2XPPeer_Manage_DelLan(XENGINE_P2XPPEER_PROTOCOL st_ClientAddr)
{
    PeerManage_IsErrorOccur = FALSE;
    //查找公网地址
